...
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/wtut_sc/simu4t/L4/comparator.sch" comparator.vf
...
module comparator(a, 
   ...
   AND7_MXILINX_comparator XLXI_1 (.I0(XLXN_14), 
                                   .I1(XLXN_13), 
                                   .I2(XLXN_12), 
                                   .I3(XLXN_11), 
                                   .I4(XLXN_10), 
   ...
   COMP8_MXILINX_comparator XLXI_4 (.A(a[39:32]), 
                                    .B(b[39:32]), 
                                    .EQ(XLXN_3));
   // synthesis attribute HU_SET of XLXI_4 is "XLXI_4_3"
   COMP8_MXILINX_comparator XLXI_5 (.A(a[31:24]), 
                                    .B(b[31:24]), 
                                    .EQ(XLXN_4));
   // synthesis attribute HU_SET of XLXI_5 is "XLXI_5_4"
   COMP8_MXILINX_comparator XLXI_6 (.A(a[23:16]), 
                                    .B(b[23:16]), 
                                    .EQ(XLXN_5));
   // synthesis attribute HU_SET of XLXI_6 is "XLXI_6_5"
   COMP8_MXILINX_comparator XLXI_7 (.A(a[15:8]), 
                                    .B(b[15:8]), 
                                    .EQ(XLXN_6));
   // synthesis attribute HU_SET of XLXI_7 is "XLXI_7_6"
   COMP8_MXILINX_comparator XLXI_8 (.A(a[7:0]), 
                                    .B(b[7:0]), 
                                    .EQ(XLXN_7));
